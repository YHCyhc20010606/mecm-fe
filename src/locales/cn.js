...
const cn = {
  ...
  system: {
    ...
    edgeNodes: {
      ...
      save: '保存',
      delete: '删除',
      matchAllCriteria: '匹配所有选定的条件。',
      matchAnyCriteria: '匹配任何选定的条件。',
      edgeCriteria: '取消选中以根据标准选择边缘。',
      capability: '能力',
      matchAll: '匹配所有',
      matchAny: '匹配任何',
      mechostIp: 'MEC 主机 IP',
  ...
  tip: {
    ...
    partSucToModNode: '修改成功，但同步到边缘节点失败，请检查！',
