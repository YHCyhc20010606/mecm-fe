...
<template>
  <div>
    ...
    <!-- [临时修改] 2025-12-31 让按钮始终显示，方便测试，完成后需改回原来的 v-if="rlp=='418'" -->
    <p
      class="btnMain"
      v-if="rlp=='418'"
    >
      ...
      <div class="tableDiv">
        <el-row class="table">
          ...
          >
            ...
            <!-- [临时修改] 2025-12-31 让操作列始终显示，完成后需改回 v-if="rlp=='418'" -->
            <el-table-column
              ...
              v-if="rlp=='418'"
            >
              <!-- [修改] 2025-12-31 将操作列宽度调整为 200填满右侧空白区域 -->
              <!-- 原代码: v-if="rlp=='418'", width="350" -->
              <template slot-scope="scope">
                <el-button
                  id="deleteBtn"
...
export default {
  ...
  methods: {
    ...
    beforeDelete (row) {
      appo.getInstanceListByHost(row.mechostIp).then(res => {
